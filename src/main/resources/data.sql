...
INSERT INTO TRAINING (ID, BULLET_POINTS, COMMENT, COURT, DURATION_MINUTES, START_TIME, WEEK_NUM, CLUB_NAME, TRAINING_GROUP_ID) VALUES(1, 'some bullet points', 'some comments', 'Court2', 18, '2022-01-03 18:30', 1, 'TC Wiesing', 1)
INSERT INTO TRAINING (ID, BULLET_POINTS, COMMENT, COURT, DURATION_MINUTES, START_TIME, WEEK_NUM, CLUB_NAME, TRAINING_GROUP_ID) VALUES(2, 'some bullet points', 'some comments', 'Court2', 15, '2022-01-01 13:30', 1, 'TC Vomp', 1)
INSERT INTO TRAINING (ID, BULLET_POINTS, COMMENT, COURT, DURATION_MINUTES, START_TIME, WEEK_NUM, CLUB_NAME, TRAINING_GROUP_ID) VALUES(3, 'some bullet points', 'some comments', 'Court2', 15, '2022-01-03 13:30', 1, 'TC Vomp', 2)
